 ...
 *	Assignment: Name Input Ignore Case
 ...
 *	equal In ignore case to the name in the 
 *	array. If there is a name equal to the 
 *	input then the console will print out 
 *	that there is a name, if there is no 
 *	name then the console will print out 
 *	that there is no name. 
 * 
 **/

public class Application_Name_Input_IgroreCase {
	...
	public static void main(String[] args){
		...
		for(int i = 0; i < names.length; i++){
			if(input_string.equalsIgnoreCase(names[i])){
